...
const data = {
  ...
  title: 'Goals Achieved with our dedicated Tutors',
  features: [
    {
      id: 1,
      imgSrc: Smart,
      ...
      text:
        'Tutoring available for all subjecrs (math, science, english and many more!',
    },
    {
      id: 2,
      imgSrc: Secure,
      ...
      text:
        'All of our tutuors are profensionally Liscenced Teachers',
    },
  ],
};
...
export default function ServiceSection() {
  ...
  const handleClick= (e) => {
    ...
    return (
      ...
      <button className="btn-primary" onClick= {() => setVideoOpen(true)}>VIEW DEMO</button>
      </section>
  );
}
